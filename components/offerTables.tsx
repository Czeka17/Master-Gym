...
function OfferTables(){
    return <section className={styles["table-list"]}>
    <Title title="karnety">
        <div className={styles["table-list__box"]}>
            <div className="circle-component third-circle"></div>
    <table data-aos="flip-right"  data-aos-delay="200" data-aos-duration="1000">
        <tbody>
            <tr>
                <th className={styles.carnets} colSpan={2}>Wejściowe</th>
            </tr>
            <tr>
                <th>Rodzaj</th>
                <th>Kwota</th>
    ...
    <table data-aos="flip-left" data-aos-delay="300" data-aos-duration="1000">
        <tbody>
            <tr>
                <th className={styles.carnets} colSpan={2}>Miesięczne</th>
            </tr>
            <tr>
                <th>Rodzaj</th>
