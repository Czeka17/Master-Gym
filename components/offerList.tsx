...
function OfferList(){
    return <section className={styles["offert-list"]}>
    <Title title='treningi personalne'>
    <div className={styles["offert-list__boxes"]}>
        <div className={styles["offert-list__box"]} data-aos="zoom-in" data-aos-delay="200">
            <h3>1 Trening</h3>
            <hr/>
            ...
            <p>Cena za pakiet: </p>
            <p className={styles["price-tag"]}>110zł</p>
            <Link href="/contact"><button>Wybierz</button></Link>
        </div>
        <div className={styles["offert-list__box"]}  data-aos="zoom-in" data-aos-delay="400">
            <h3>4 Treningi</h3>
            <hr/>
            <p>Cena za jeden trening: </p>
    ...
    <div className={styles["offert-list__coach"]} data-aos="zoom-in" data-aos-delay="200">
